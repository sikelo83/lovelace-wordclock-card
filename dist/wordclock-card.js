 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return dt({...t,state:!0,attribute:!1})}const pt=(t,e,s)=>({row:t,col:e,len:s}),_t=t=>5*Math.floor(t%60/5),gt=(t,e)=>(t+(e?1:0)+11)%12,ft=pt(0,0,2),$t=pt(0,3,3),mt=pt(0,7,4),vt=pt(1,0,4),At=pt(1,4,7),Et=pt(2,4,7),yt=pt(3,0,3),bt=pt(3,7,4),wt=pt(4,0,4),St=pt(9,8,3),Ct=pt(5,0,3),Pt=[pt(5,0,4),pt(5,7,4),pt(6,0,4),pt(6,7,4),pt(4,7,4),pt(7,0,5),pt(8,0,6),pt(7,7,4),pt(9,3,4),pt(9,0,4),pt(4,5,3),pt(8,6,5)],Tt={grid:["ESKISTAFÜNF","ZEHNZWANZIG","DREIVIERTEL","VORFUNKNACH","HALBAELFÜNF","EINSXAMZWEI","DREIPMJVIER","SECHSNLACHT","SIEBENZWÖLF","ZEHNEUNKUHR"],timeToWords(t,e){const s=_t(e),i=gt(t,s>=25),r=Pt[i],n=[ft,$t];switch(s){case 0:return[...n,0===i?Ct:r,St];case 5:return[...n,mt,bt,r];case 10:return[...n,vt,bt,r];case 15:return[...n,Et,bt,r];case 20:return[...n,At,bt,r];case 25:return[...n,mt,yt,wt,r];case 30:return[...n,wt,r];case 35:return[...n,mt,bt,wt,r];case 40:return[...n,At,yt,r];case 45:return[...n,Et,yt,r];case 50:return[...n,vt,yt,r];default:return[...n,mt,yt,r]}}},xt=pt(0,0,2),Ut=pt(0,3,4),Nt=pt(0,8,3),Ot=pt(1,0,6),kt=pt(1,8,3),Ht=pt(2,0,6),Rt=pt(2,8,3),It=pt(3,0,2),Mt=pt(3,3,5),Lt=[pt(4,0,3),pt(4,3,4),pt(4,8,3),pt(5,0,5),pt(5,5,4),pt(6,0,6),pt(6,6,5),pt(7,0,5),pt(7,5,4),pt(8,0,4),pt(8,7,4),pt(9,0,6)],Bt={grid:["ESKISCHAFÜF","VIERTUBFZÄÄ","ZWÄNZGSIVOR","ABOHAUBIEGE","EISZWÖISDRÜ","VIERIFÜFIQT","SÄCHSISIBNI","ACHTINÜNIEL","ZÄNIERBEUFI","ZWÖUFIAMUHR"],timeToWords(t,e){const s=_t(e),i=Lt[gt(t,s>=25)],r=[xt,Ut];switch(s){case 0:return[...r,i];case 5:return[...r,Nt,It,i];case 10:return[...r,kt,It,i];case 15:return[...r,Ot,It,i];case 20:return[...r,Ht,It,i];case 25:return[...r,Nt,Rt,Mt,i];case 30:return[...r,Mt,i];case 35:return[...r,Nt,It,Mt,i];case 40:return[...r,Ht,Rt,i];case 45:return[...r,Ot,Rt,i];case 50:return[...r,kt,Rt,i];default:return[...r,Nt,Rt,i]}}},Dt=pt(0,0,2),Wt=pt(0,3,2),jt=pt(1,0,1),qt=pt(1,2,7),zt=pt(2,0,6),Ft=pt(2,6,4),Vt=pt(3,0,4),Zt=pt(3,5,3),Gt=pt(3,9,2),Kt=pt(4,0,4),Jt=pt(9,5,6),Xt=[pt(5,0,3),pt(6,8,3),pt(5,6,5),pt(6,0,4),pt(6,4,4),pt(5,3,3),pt(8,0,5),pt(7,0,5),pt(4,7,4),pt(9,0,3),pt(7,5,6),pt(8,5,6)],Qt={grid:["ITLISASAMPM","ACQUARTERDC","TWENTYFIVEX","HALFSTENFTO","PASTERUNINE","ONESIXTHREE","FOURFIVETWO","EIGHTELEVEN","SEVENTWELVE","TENSEOCLOCK"],timeToWords(t,e){const s=_t(e),i=Xt[gt(t,s>=35)],r=[Dt,Wt];switch(s){case 0:return[...r,i,Jt];case 5:return[...r,Ft,Kt,i];case 10:return[...r,Zt,Kt,i];case 15:return[...r,jt,qt,Kt,i];case 20:return[...r,zt,Kt,i];case 25:return[...r,zt,Ft,Kt,i];case 30:return[...r,Vt,Kt,i];case 35:return[...r,zt,Ft,Gt,i];case 40:return[...r,zt,Gt,i];case 45:return[...r,jt,qt,Gt,i];case 50:return[...r,Zt,Gt,i];default:return[...r,Ft,Gt,i]}}},Yt=t=>{const e=t?.match(/^#?([0-9a-f]{6})$/i);if(!e)return;const s=parseInt(e[1],16);return[s>>16&255,s>>8&255,255&s]},te=t=>Array.isArray(t)?`#${t.map(t=>t.toString(16).padStart(2,"0")).join("")}`:void 0,ee={de:{language:"Sprache",active_color:"Farbe der aktiven Buchstaben",minute_dots:"Minuten-Punkte (+1…+4) anzeigen",advanced:"Erweitert",inactive_color:"Farbe der inaktiven Buchstaben",background:"Hintergrundfarbe",lang_de:"Deutsch",lang_ch:"Schweizerdeutsch (Bärndütsch)",lang_en:"Englisch"},en:{language:"Language",active_color:"Active letter color",minute_dots:"Show minute dots (+1…+4)",advanced:"Advanced",inactive_color:"Inactive letter color",background:"Background color",lang_de:"German",lang_ch:"Swiss German (Bärndütsch)",lang_en:"English"}};let se=class extends ot{setConfig(t){this._config=t}_labels(){return(this.hass?.locale?.language??this.hass?.language??"en").toLowerCase().startsWith("de")?ee.de:ee.en}_schema(t){return[{name:"language",required:!0,selector:{select:{mode:"dropdown",options:[{value:"de",label:t.lang_de},{value:"ch",label:t.lang_ch},{value:"en",label:t.lang_en}]}}},{name:"active_color",selector:{color_rgb:{}}},{name:"minute_dots",selector:{boolean:{}}},{name:"advanced",type:"expandable",flatten:!0,title:t.advanced,schema:[{name:"inactive_color",selector:{color_rgb:{}}},{name:"background",selector:{color_rgb:{}}}]}]}render(){if(!this._config)return z;const t=this._labels(),e={language:this._config.language??"de",active_color:Yt(this._config.active_color??"#ffb300"),minute_dots:this._config.minute_dots??!0,inactive_color:Yt(this._config.inactive_color),background:Yt(this._config.background)};return j`
      <ha-form
        .hass=${this.hass}
        .data=${e}
